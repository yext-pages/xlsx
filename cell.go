...
func newCell(r *Row, num int) *Cell {
	return &Cell{Row: r, num: num}
}

// Write persists changes made to a Cell.  You must call Write, before
// releasing your reference to the cell, for any changes you have made
// to be stored.
func (c *Cell) Write() error {
	return c.Row.Sheet.cellStore.WriteCell(c)
}
